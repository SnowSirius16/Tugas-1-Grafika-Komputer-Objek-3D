...
void Demo::BuildColoredCube() {
	...
	int width, height;
	unsigned char* image = SOIL_load_image("obj2.png", &width, &height, 0, SOIL_LOAD_RGBA);
...
void Demo::BuildColoredTop()
{
	...
	int width, height;
	unsigned char* image = SOIL_load_image("obj2A.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
